...
steel.d("components/myBorrowBookList/index/ctrl", [],function(require, exports, module) {
/**
 * 模块控制器
 */
...
module.exports = function(control) {
    control.set({
        tpl: 'tpl/myBorrowBookList/myBorrowBookList',
        data: null
    });
};
});
steel.d("app", ["tpl/common/loading","ui/tip","components/main/index/ctrl","components/bookList/index/ctrl","components/login/index/ctrl","components/myBorrowBookList/index/ctrl"],function(require, exports, module) {
/**
 * 应用入口文件
 */
...
require('components/myBorrowBookList/index/ctrl');
...
steel.config({
    ...
    router: [
        ...
        ['/catfood/mybooklist', 'components/myBorrowBookList/index/ctrl']
    ]
});
