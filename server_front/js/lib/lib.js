...
var Zepto = (function() {
  ...
  ;['width', 'height'].forEach(function(dimension){
    var dimensionProperty =
      dimension.replace(/./, function(m){ return m[0]&&m[0].toUpperCase() })
