...
steel.d("tpl/common/input", ["tpl/runtime"],function(require, exports, module) {
...
buf.push("<!--模块模板--><div node-type=\"input\" class=\"content\"><div class=\"logo\"><img src=\"http://js.catfood.wap.grid.sina.com.cn/img/logo.png\"/></div><div class=\"form\"><form><input type=\"text\" placeholder=\"公司邮箱前缀\" node-type=\"mail\" class=\"text\"/><br/><input type=\"password\" placeholder=\"公司邮箱密码\" node-type=\"password\" class=\"text\"/><br/><p node-type=\"warn\"></p><input type=\"button\" value=\"登录\" node-type=\"login\" class=\"login\"/></form></div></div>");;return buf.join("");
};
});