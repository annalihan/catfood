...
steel.d("tpl/common/radar", ["tpl/runtime"],function(require, exports, module) {
...
buf.push("<!--模块模板--><div node-type=\"radar\" class=\"radar\"><canvas node-type=\"myCanvas\" class=\"myCanvas\">Your browser does not support the canvas element.</canvas><a href=\"bookList\" node-type=\"borrow\" class=\"borrow\">我要借书</a></div>");;return buf.join("");
};
});