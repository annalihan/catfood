...
steel.d("tpl/login/login", ["tpl/runtime"],function(require, exports, module) {
...
buf.push("<!--模块模板--><div s-child=\"s-child\" s-tpl=\"tpl/common/header\" s-logic=\"logic/header\" s-data=\"null\"></div><div s-child=\"s-child\" s-tpl=\"tpl/common/input\" s-logic=\"logic/input\" s-data=\"null\"></div>");;return buf.join("");
};
});